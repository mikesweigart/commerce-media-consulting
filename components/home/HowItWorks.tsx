...
const steps = [
  {
    ...
    desc: "Share your current GTM, the pains you're experiencing, and your two-year growth goals. We'll spend 90 minutes diagnosing your situation — no generic advice, no pitch.",
    cta: null,
  },
  {
    number: "2",
    icon: Map,
    title: "Receive Your 5-Part Growth Plan",
